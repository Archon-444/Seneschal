...
// ── Sensitive templates (T9.1 hardening). A sensitive template's body carries a secret
  // (a reset URL, or a secure-link /link/<token> URL — a bearer credential) that must NEVER be
...
const SENSITIVE_TEMPLATE_PLACEHOLDER: Record<string, string> = {
  auth_reset_v1: "A password-reset link was sent to your email. It expires in 1 hour.",
  ...
  // let the live body ride the outbox payload, exactly like a reset URL.
